...
```
本章で論じるのは、Googleのルールとガイダンスの開発を舵取りする原理とプロセスであり、主にGoogleのC++、Python、Javaのスタイルガイドから事例を引いて進める。
```

### 8.1 なぜルールを設けるのか

まず、当該組織が何に価値を置くかを認識する必要がある。そうしないと、ルールに沿わないものは全て悪になりかねない。

### 8.2 ルールを作る

どんなルールを備えるべきか、よりもどんなゴールを前進させようとしているのか、を考える。
